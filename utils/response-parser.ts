import type { SubtitleSummary, MindmapData, ValidatorFunction, ParseOptions, ParseResult } from './types'
...
export class ResponseParser {
   ...
   * 解析思维导图响应
   */
  static parseMindmapResponse(content: string, options: ParseOptions = {}): any {
   ...
   * 解析字幕总结响应
   */
  static parseSubtitleSummaryResponse(content: string, options: ParseOptions = {}): SubtitleSummary {
